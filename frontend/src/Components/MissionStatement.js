    ...
    return(
        <div>
            ...
            <div className = "about">
                ...
                <p className = "p">Supplied started during the YYC Code The Change 2022 Hackathon, where our team of 5 had an idea that could help all students reach their educatonal goals.</p>
            </div>
        </div>
    )
}
